...
L'inscription est gratuite et requiert la fourniture d'informations exactes (nom commercial, email professionnel, mot de passe). Le Commerçant garantit être un professionnel inscrit au Registre du Commerce et des Sociétés ou au Répertoire des Métiers, ou exercer une activité professionnelle déclarée (auto-entrepreneur, micro-entreprise, profession libérale).

Le Service inclut une période d'essai gratuite, activée automatiquement à la création du compte. À l'issue de cette période, l'accès au Service est suspendu tant que le Commerçant n'a pas activé un abonnement payant depuis son espace personnel. Aucun prélèvement n'est effectué pendant l'essai.

Le Commerçant est seul responsable de la confidentialité de ses identifiants de connexion et de toute action effectuée depuis son compte.
...
- Un QR code fixe d'établissement permettant l'auto-inscription des nouveaux clients.
- Un tableau de bord de gestion des clients, statistiques, employés et établissements.
- L'hébergement, l'exploitation et la maintenance technique de l'ensemble.

Fidéo peut faire évoluer le périmètre fonctionnel du Service à tout moment, sans dégradation substantielle des fonctionnalités essentielles souscrites par le Commerçant.
...
L'abonnement est conclu pour une durée mensuelle ou annuelle, reconduite tacitement par périodes identiques sauf résiliation.
...
Conformément à l'article L221-3 du Code de la consommation, le droit de rétractation de 14 jours peut s'appliquer aux Commerçants employant 5 salariés ou moins lorsque le contrat n'entre pas dans le champ de leur activité principale.

Lorsqu'il est applicable, le Commerçant qui demande l'exécution immédiate du Service avant la fin du délai de 14 jours renonce expressément à son droit de rétractation, conformément à l'article L221-25 du Code de la consommation. La validation de l'abonnement et l'utilisation du Service constituent cette demande expresse.
...
L'ensemble des éléments composant le Service (code source, design, marque « Fidéo », documentation) est la propriété exclusive de TXM Production ou de ses concédants. Toute reproduction, modification, diffusion ou exploitation non autorisée est interdite et constitue une contrefaçon (art. L335-2 et s. CPI).

Le Commerçant conserve l'intégralité des droits sur les contenus qu'il publie (logo, photos, textes). Il concède à Fidéo une licence non exclusive et gratuite, pour la durée du contrat, à seule fin d'exploiter le Service (affichage sur les passes, sauvegarde, distribution aux clients finaux via Apple/Google Wallet).

## 10. Disponibilité du Service et limitation de responsabilité

Fidéo met en œuvre des moyens raisonnables pour assurer une disponibilité continue du Service. Aucune disponibilité 100% n'est garantie. Fidéo ne saurait être tenu responsable :
...
Le traitement des données personnelles est régi par notre Politique de Confidentialité et, s'agissant des données des clients finaux du Commerçant, par le Contrat de Sous-traitance (DPA).

## 12. Modification des Conditions

Fidéo peut modifier les présentes Conditions à tout moment. Toute modification substantielle est notifiée au Commerçant par email au moins 30 jours avant son entrée en vigueur. À défaut d'opposition par résiliation dans ce délai, la poursuite de l'utilisation vaut acceptation des nouvelles Conditions.

## 13. Règlement amiable des litiges

En cas de différend relatif à l'exécution des présentes Conditions, les parties s'efforceront de trouver une solution amiable avant tout recours juridictionnel. Le Commerçant peut adresser sa réclamation à contact.txmproduction@gmail.com ; Fidéo y répond dans un délai raisonnable.

## 14. Droit applicable et tribunal compétent

Les présentes Conditions sont régies par le droit français. À défaut de résolution amiable, tout litige relève des tribunaux du ressort du siège social de TXM Production (Paris).

## 15. Contact

Pour toute question relative aux présentes Conditions ou RGPD : contact.txmproduction@gmail.com
